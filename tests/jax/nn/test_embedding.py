...
class TestEmbedding:
    ...
    @pytest.mark.order(1)
    def test_init(self, embedding_fixture: tuple[Embedding, jax.Array]) -> None:
        """
        ...
        assert (
            len_parameters == 3
        ), f"Incorrect parameters length, expected 3 and got {len_parameters}"

    @pytest.mark.order(2)
    def test_forward(self, embedding_fixture: tuple[Embedding, jax.Array]) -> None:
        """
    ...
    @pytest.mark.order(3)
    def test_backward(self, embedding_fixture: tuple[Embedding, jax.Array]) -> None:
        """
    ...
    @pytest.mark.order(4)
    def test_freeze(self, embedding_fixture: tuple[Embedding, jax.Array]) -> None:
        """
    ...
    @pytest.mark.order(5)
    def test_kl_cost(self, embedding_fixture: tuple[Embedding, jax.Array]) -> None:
        """
